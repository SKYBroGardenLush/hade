...
import (
	...
	"github.com/SKYBroGardenLush/skyscraper/framework/middlewares/gin-swagger/example/basic/api"

	_ "github.com/SKYBroGardenLush/skyscraper/framework/middlewares/gin-swagger/example/basic/docs"
)
