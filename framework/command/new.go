...
var newCommand = &cobra.Command{
	...
	RunE: func(c *cobra.Command, args []string) error {
		...
		// 版本号
		{
			...
			prompt := &survey.Input{
				Message: "请输入版本名称(参考 https://github.com/SKYBroGardenLush/skyscraper/release,默认为最新版本):",
			}
			...
			if version != "" {
				...
				if err != nil || release == nil {
					fmt.Println("所需版本不存在，创建失败，请参考 https://github.com/SKYBroGardenLush/skyscraper/release")
				}
			} else if version == "" {
